		...
		<form class="form" action="StoreJoin" method="post">
			...
			<div class="store_BasicInfo">
				...
				<br> <span style="font-weight: bold;">카테고리</span><br><br> <input
					...
					type="radio" name="store_Cate" value="순대">순대 <input
					type="radio" name="store_Cate" value="분식류">분식류 <input
					type="radio" name="store_Cate" value="기타">기타
			</div>
			<br> <br>
			<div class="store_openInfo">
				...
				<br> <span>영업 오픈 시간&nbsp;</span><input name="store_Open_Dt"
					...
					type="number" class="Cook_time" max="120" width="20px" text-align="right"  required>분<br><br><br>
